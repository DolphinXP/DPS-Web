...
@Component({
    ...
    standalone: true,
    templateUrl: './workflow-list-component1.component.html',
    imports: [
        CommonModule,
        NzTableModule,
        NgForOf,
    ...
    styleUrls: ['./workflow-list-component1.component.css']
})
export class WorkflowListComponent1 implements OnInit {
    workflows: any;
